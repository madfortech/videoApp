...
class CommentController extends Controller
{
    ...
    public function create()
    {
        ...
        $posts = Post::pluck('description', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('frontend.comments.create', compact('posts'));
    }
    ...
    public function edit(Comment $comment)
    {
        ...
        return view('frontend.comments.edit', compact('comment', 'posts'));
    }
